...
[![Downloads](https://img.shields.io/badge/Direct_Download-Telegram-ff007f?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/ibrprojects/4)
...
Control the entire engine straight from your keyboard:

| Shortcut | Action | Description |
| :---: | :--- | :--- |
| <kbd>Q</kbd> | **Stealth Mode** | Instantly hide or show arrows and dashboard overlays |
| <kbd>E</kbd> | **Toggle Engine** | Turn move calculations on/off on the fly |
| <kbd>R</kbd> | **Force Rescan** | Instantly re-evaluate the current board position |
| <kbd>C</kbd> | **Copy FEN** | Copy current board FEN string to clipboard |
| <kbd>M</kbd> | **Copy Best Move** | Copy engine's suggested move (e.g., `e2e4`) |
| <kbd>P</kbd> | **Promotion Advice** | Re-run branch analysis on promotion squares |

---

## 🚀 Installation & Setup

> **Supported Browsers:** Google Chrome, Brave, Microsoft Edge, Opera, Kiwi Browser (Android).

### 3-Step Quick Install:

1. **Download the Package:**
   - Grab the latest release archive directly from [Telegram Channel](https://t.me/ibrprojects/4).
...
3. **Load the Extension:**
   ...
   - Open [Chess.com](https://www.chess.com) and start any game or analysis — the engine connects automatically! ♟️

---

## 🎨 Themes & Customization

Open the extension popup dashboard to customize your setup:

- **Arrow Styles:** Solid Pure Black, Neon Glow, Cyber Dashed, Stealth Dot.
- **Color Palettes:** Pure Black, Emerald Green, Electric Blue, Cyber Purple, Amber Gold.
- **Engine Depth:** Scalable from Depth 8 to Depth 18 NNUE.
- **Audio Feedback:** Subtle audio cues on calculated moves.

---

## 📢 Community & Support

Join our official community for fast updates, bug fixes, and feature requests:
...
<sub>*Disclaimer: IBR Chess Engine is intended for educational, training, and game analysis purposes.*</sub>
